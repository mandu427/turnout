...
1. Does the over-reporting pattern vary by state, and if so, is there a useful pattern there?
2. How does over-reporting vary by key demographic and political traits?
3. Does having strong/large social networks increase the probability that an individual will over-report, conditional on not having voted?
